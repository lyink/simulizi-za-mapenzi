                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _DrawerItem(
                        ...
                        label: 'First Love',
                        isActive: activeCategory == 'First Love',
                        onTap: () => _goHome(context, 'First Love'),
                      ),
                      _DrawerItem(
                        icon: Icons.favorite_rounded,
                        label: 'Modern Romance',
                        isActive: activeCategory == 'Modern Romance',
                        onTap: () => _goHome(context, 'Modern Romance'),
                      ),
                      _DrawerItem(
                        icon: Icons.auto_stories_rounded,
                        label: 'Traditional Love',
                        isActive: activeCategory == 'Traditional Love',
                        onTap: () => _goHome(context, 'Traditional Love'),
                      ),
                      _DrawerItem(
                        icon: Icons.heart_broken_rounded,
                        label: 'Heartbreak',
                        isActive: activeCategory == 'Heartbreak',
                        onTap: () => _goHome(context, 'Heartbreak'),
                      ),
                      _DrawerItem(
                        icon: Icons.family_restroom_rounded,
                        label: 'Marriage',
                        isActive: activeCategory == 'Marriage',
                        onTap: () => _goHome(context, 'Marriage'),
                      ),
                      _DrawerItem(
                        icon: Icons.whatshot_rounded,
                        label: 'Passion',
                        isActive: activeCategory == 'Passion',
                        onTap: () => _goHome(context, 'Passion'),
                      ),
                      _DrawerItem(
                        icon: Icons.replay_rounded,
                        label: 'Reunion',
                        isActive: activeCategory == 'Reunion',
                        onTap: () => _goHome(context, 'Reunion'),
                      ),
                    ],
                  ),
                ),
